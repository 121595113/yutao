    ...
    module.exports = Zepto,
        function($) {
            $.fn.wx = function(option) {
                ...
                var $wx = $(this),
                    opts = $.extend({}, $.fn.wx.defaults, option);
                            ...
                            pay: function(data, handlerMap) {
                                CallWeiXinAPI(function() {
                                    var requireData = {
                                        ...
                                        handler = null,
                                        args = [data];
                                    for (var key in requireData) requireData.hasOwnProperty(key) && (requireData[key] = data[key] || "", console.info(key + " = " + requireData[key]));
